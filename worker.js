...
fileQueue.process(async (job) => {
  ...
  if (!basicUtils.isValidMongoId(fileId) || !basicUtils.isValidMongoId(userId)) throw new Error('File not found');
...
userQueue.process(async (job) => {
  ...
  if (!basicUtils.isValidMongoId(userId)) throw new Error('User not found');
